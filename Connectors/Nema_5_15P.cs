...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class Nema_5_15P : RectangleFBase
	{

		#region Constructors

		protected internal Nema_5_15P(ShapeType shapeType, Template template)
		...
		protected internal Nema_5_15P(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new Nema_5_15P(Type, Template);
		...
		protected override bool CalculatePath()
		{
			if (base.CalculatePath())
			{
				...
				Path.AddRectangle(new RectangleF(-7.874F * Scale, 0.005F * -1 * Scale, 1.524F * Scale, 6.604F * Scale));
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("Nema_5_15P", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new Nema_5_15P(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.Nema_5_15P);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int Nema_5_15PMiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.Nema_5_15PMiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.Nema_5_15PMiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.Nema_5_15PMiddleCenter:
