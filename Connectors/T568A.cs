...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class T568A : RectangleFBase
	{

		#region Constructors

		protected internal T568A(ShapeType shapeType, Template template)
		...
		protected internal T568A(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new T568A(Type, Template);
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("T568A", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new T568A(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.T568A);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int T568AMiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.T568AMiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.T568AMiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.T568AMiddleCenter:
