	...
	public class IEC60320_C17 : RectangleFBase
	{
		...
		protected override bool CalculatePath()
		{
			if (base.CalculatePath())
			{
				...
				Path.AddLines(new PointF[]{new PointF(-11.5F * Scale, 2.5F * -1 * Scale), new PointF(-7.681623F * Scale, 8F * -1 * Scale), new PointF(7.681623F * Scale, 8F * -1 * Scale), new PointF(11.5F * Scale, 2.5F * -1 * Scale)});
				Path.AddArc(8F * Scale, -4.5F * -1 * Scale, 3.5F * Scale, 3.5F * Scale, 360F, 90F);
				Path.AddArc(-11.5F * Scale, -4.5F * -1 * Scale, 3.5F * Scale, 3.5F * Scale, 90F, 90F);
				Path.CloseFigure();
