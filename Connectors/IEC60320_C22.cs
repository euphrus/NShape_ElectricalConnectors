...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class IEC60320_C22 : RectangleFBase
	{

		#region Constructors

		protected internal IEC60320_C22(ShapeType shapeType, Template template)
		...
		protected internal IEC60320_C22(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new IEC60320_C22(Type, Template);
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("IEC60320_C22", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new IEC60320_C22(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.IEC60320_C22);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int IEC60320_C22MiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.IEC60320_C22MiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.IEC60320_C22MiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.IEC60320_C22MiddleCenter:
