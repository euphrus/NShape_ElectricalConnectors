...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class Nema_5_20P : RectangleFBase
	{

		#region Constructors

		protected internal Nema_5_20P(ShapeType shapeType, Template template)
		...
		protected internal Nema_5_20P(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new Nema_5_20P(Type, Template);
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("Nema_5_20P", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new Nema_5_20P(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.Nema_5_20P);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int Nema_5_20PMiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.Nema_5_20PMiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.Nema_5_20PMiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.Nema_5_20PMiddleCenter:
