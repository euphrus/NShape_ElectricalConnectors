	...
	public class WireWrap : RectangleFBase
	{
		...
		protected override bool CalculatePath()
		{
			if (base.CalculatePath())
			{
				Path.Reset();
				Path.Reset();
				Path.AddRectangle(new RectangleF(-10F * Scale, 1F * -1 * Scale, 20F * Scale, 2F * Scale));
				Path.AddRectangle(new RectangleF(-9.215F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(-6.675F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(-4.135F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(-1.595F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(0.945F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(3.485F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(6.025F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddRectangle(new RectangleF(8.565F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale));
				Path.AddArc(-9.215F * Scale, 0.3175F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(-6.675F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(-4.135F * Scale, 0.3255F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(-1.595F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(0.945F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(3.485F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(6.025F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				Path.AddArc(8.565F * Scale, 0.325F * -1 * Scale, 0.65F * Scale, 0.65F * Scale, 180F, 360F);
				return true;
			}
			return false;
		}
