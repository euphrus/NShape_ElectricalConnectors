...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class T568B : RectangleFBase
	{

		#region Constructors

		protected internal T568B(ShapeType shapeType, Template template)
		...
		protected internal T568B(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new T568B(Type, Template);
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("T568B", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new T568B(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.T568B);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int T568BMiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.T568BMiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.T568BMiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.T568BMiddleCenter:
