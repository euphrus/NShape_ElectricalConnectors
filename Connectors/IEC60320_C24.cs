...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class IEC60320_C24 : RectangleFBase
	{

		#region Constructors

		protected internal IEC60320_C24(ShapeType shapeType, Template template)
		...
		protected internal IEC60320_C24(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new IEC60320_C24(Type, Template);
		...
		protected override bool CalculatePath()
		{
			if (base.CalculatePath())
			{
				...
				Path.AddArc(-14.5F * Scale, 10.5F * -1 * Scale, 3F * Scale, 3F * Scale, 180F, 90F);
				Path.AddArc(11.5F * Scale, 10.5F * -1 * Scale, 3F * Scale, 3F * Scale, 270F, 90F);
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("IEC60320_C24", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new IEC60320_C24(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.IEC60320_C24);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int IEC60320_C24MiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.IEC60320_C24MiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.IEC60320_C24MiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.IEC60320_C24MiddleCenter:
