...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class Nema_6_50P : RectangleFBase
	{

		#region Constructors

		protected internal Nema_6_50P(ShapeType shapeType, Template template)
		...
		protected internal Nema_6_50P(ShapeType shapeType, IStyleSet styleSet)
		...
		{
			Shape result = new Nema_6_50P(Type, Template);
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("Nema_6_50P", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new Nema_6_50P(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.Nema_6_50P);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int Nema_6_50PMiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.Nema_6_50PMiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.Nema_6_50PMiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.Nema_6_50PMiddleCenter:
