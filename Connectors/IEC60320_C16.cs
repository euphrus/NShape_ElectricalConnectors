...
namespace Windstream.Shapes.NShape.Electrical.Connectors
{
	...
	public class IEC60320_C16 : RectangleFBase
	{
		...
		{
			Shape result = new IEC60320_C16(Type, Template);
		...
		protected override bool CalculatePath()
		{
			if (base.CalculatePath())
			{
				...
				Path.AddLines(new PointF[]{new PointF(-12F * Scale, 3F * -1 * Scale), new PointF(-8.464466F * Scale, 8F * -1 * Scale), new PointF(8.464466F * Scale, 8F * -1 * Scale), new PointF(12F * Scale, 3F * -1 * Scale)});
				Path.AddArc(9F * Scale, -4.9F * -1 * Scale, 3F * Scale, 3F * Scale, 360F, 90F);
				Path.AddArc(2.5F * Scale, -6.65F * -1 * Scale, 1.25F * Scale, 1.25F * Scale, 90F, 90F);
				Path.AddArc(-2.5F * Scale, -2.5F * -1 * Scale, 5F * Scale, 5F * Scale, 360F, -180F);
				Path.AddArc(-3.75F * Scale, -6.65F * -1 * Scale, 1.25F * Scale, 1.25F * Scale, 360F, 90F);
				Path.AddArc(-12F * Scale, -4.9F * -1 * Scale, 3F * Scale, 3F * Scale, 90F, 90F);
				Path.CloseFigure();
		...
		public static ShapeType GetShapeType()
		{
			...
			return new ShapeType("IEC60320_C16", libraryName, libraryName,
					delegate(ShapeType s, Template t) { return new IEC60320_C16(s, t); },
			RectangleFBase.GetPropertyDefinitions, Windstream.Shapes.NShape.Electrical.Connectors.Properties.Resources.IEC60320_C16);
		}
		...
		new public class ControlPointIds
		{
			...
			public const int IEC60320_C16MiddleCenter = 2;
		}
		...
		protected override void CalcControlPoints()
		{
			...
			ControlPoints[ControlPointIds.IEC60320_C16MiddleCenter] = Point.Empty;
		}
		...
		public override IEnumerable<ControlPointId> GetControlPointIds(ControlPointCapabilities controlPointCapability)
		{
			...
			{
				returnValue.Add(ControlPointIds.IEC60320_C16MiddleCenter);
			}
			return returnValue;
		}
		...
		public override bool HasControlPointCapability(ControlPointId controlPointId, ControlPointCapabilities controlPointCapability)
		{
			...
			switch (controlPointId)
			{
				...
				case ControlPointId.Reference:
					...
					break;
				case ControlPointIds.IEC60320_C16MiddleCenter:
